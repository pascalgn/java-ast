...
export class JavaLexer extends Lexer {
  ...
  static readonly modeNames: string[] = ['DEFAULT_MODE'];
  ...
  private static readonly _serializedATNSegment1: string =
    '\x02\x02\x02\u01AB\u01AC\x07p\x02\x02\u01AC\u01AD\x07c\x02\x02\u01AD\u01AE' +
  ...
  static readonly _serializedATN: string = Utils.join(
    [JavaLexer._serializedATNSegment0, JavaLexer._serializedATNSegment1],
    '',
  );
  static __ATN: ATN;
  static get _ATN(): ATN {
    if (!JavaLexer.__ATN) {
      JavaLexer.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(JavaLexer._serializedATN),
      );
    }
